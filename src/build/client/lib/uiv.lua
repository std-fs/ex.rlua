...
if game.CoreGui:FindFirstChild("bloxtest_fs") then
	game:GetService("CoreGui")["bloxtest_fs"]:Destroy()
end
...
function lib:frame(text, preset, closebind)
